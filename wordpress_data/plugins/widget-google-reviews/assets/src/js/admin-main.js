                ...
                success  : function(res) {
                    ...
                    if (res.stats_minmax.length) {
                        ...
                        for (let i = 0; i < res.stats_minmax.length; i++) {
                            ...
                            if (minmax[gpid]) {
                                ...
                                if (stats_result) {
                                    stats_result = {
                                        time         : review_count.time + minmax[gpid].time,
                                        rating       : review_count.rating + minmax[gpid].rating,
                    ...
                    for (var i = 0; i < months; i++) {
                        var startDay = new Date(today.getFullYear(), today.getMonth() - i, 1),
                            ...
                            month    = startDay.toLocaleString('default', {month: 'short'});
                    ...
                    if (chart) {
                        chart.updateSeries([{name: 'Reviews', data: data}]);
                    } else {
